...
#  Before running reprepro, user must arrange the import of certificates of keys into gpg.
/usr/bin/reprepro --noskipold --basedir ./ --conf +b/multi-conf --morguedir +b/morguedir update
